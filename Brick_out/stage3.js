        ...
        var bricks = [];
         for(var c = 0; c < brickColumnCount; c++) {
            ...
            for(var r = 0; r < brickRowCount; r++) {
                if((c==2)&&(r==2)){
                    bricks[c][r] = {x: 0, y: 0, status:thickness-2};
                    totalScore=totalScore+thickness-2;
                }else if((c==1||c==2||c==3)&&(r==1||r==2||r==3)){
                ...
                for(var r=0; r<brickRowCount; r++) {
                    ...
                    if(b.status > 0) {
                        ...
                        || (x > b.x && x < b.x + brickWidth && y - ballRadius > b.y && y - ballRadius < b.y + brickHeight)) {
                            ...
                            dy = -dy*(1+(Math.floor(Math.random()*10)%5)/10);
                            if(dy>4)
                                dy = 4;
                            else if(dy<-4)
                                dy=-4;
                            ...
                            if(score == totalScore) {
                                alert("팀 프로젝트 만점!\n* 현재 학점: 3.5");
                                window.location.replace("story3.html");
                            }
                            check_flag = b;
                        }
                        ...
                        || (x - ballRadius > b.x && x - ballRadius < b.x + brickWidth && y > b.y && y < b.y + brickHeight)) {
                            ...
                            dx = -dx*(1+(Math.floor(Math.random()*10)%5)/10);
                            if(dx>4)
                                dx = 4;
                            else if(dx<-4)
                                dx=-4;
